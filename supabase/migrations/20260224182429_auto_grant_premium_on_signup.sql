/*
  # Auto-grant premium access on signup

  1. Changes
    - Update handle_new_user() trigger to set premium_unlocked = true for all new users
    - All users now get premium access automatically when they sign up
  
  2. Why
    - The app is now free with all features unlocked
    - Premium features are available to everyone by default
    - Monetization is through Google Play Store listing instead
*/
...
BEGIN
  ...
  VALUES (
    ...
    0,     -- No referrals yet
    true,  -- AUTO-GRANT PREMIUM ACCESS
